...
data_name = DATASETS.RSICD +'_5_cap_per_img_2_min_word_freq'  # base name shared by data files {nr of captions per img and min word freq in create_input_files.py}
checkpoint = PATH_DATA(ARCHITECTURE, data_name = data_name, checkpoint = True, fine_tune = False)
...
#evaluation
ATTENTION = ATTENTION.soft_attention  # todo hard_attention
