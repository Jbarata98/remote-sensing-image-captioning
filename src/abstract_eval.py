...
class AbstractEvaluator:
    ...
    #             # Hypotheses
    #             hypotheses.append(
    #                 ' '.join(self.rev_word_map[w] for w in seq if w not in self._get_special_tokens(self.word_map)))
    #             # print(hypotheses)
    #
    ...
    #                 AuxLM_tokenizer.decode(AuxLM_tokenizer.convert_tokens_to_ids(self.rev_word_map[w])) for w in seq if
    #                 w not in self._get_special_tokens(self.word_map)))
    #         # print(hypotheses)
