...
class LSTMWithTopDownAttention(LSTMWithAttention):
    ...
    def __init__(self, embed_dim, decoder_dim, encoder_dim=2048):
        """
        ...
        super(LSTMWithTopDownAttention, self).__init__()

        self.LanguageLSTM = nn.LSTMCell(encoder_dim, decoder_dim, bias=True)  # decoding Language LSTM
        self.TopDownLSTM = nn.LSTMCell(embed_dim + encoder_dim, decoder_dim, bias=True)  # TopDown_Attention
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths):
        ...
        #         (h_language[:batch_size_t], c_language[:batch_size_t]))  # (batch_size_t, decoder_dim)
        #
        #     h_language,c_language = self.LanguageLSTM(,(h_topdown[:batch_size_t], c_topdown[:batch_size_t]))
