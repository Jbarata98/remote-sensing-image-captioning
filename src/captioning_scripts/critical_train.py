"""Code by https://github.com/RitaRamo/ic/blob/main/src/critical_train.py"""

from src.metrics_files.pycocoevalcap.cider.cider import Cider
from src.metrics_files.pycocoevalcap.bleu.bleu import Bleu
import torch


class CriticalTraining:
    """
    class to perform self-critical training
    """
