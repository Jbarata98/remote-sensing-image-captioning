...
features_list = feature_list = pickle.load(open('/experiments/encoder/features/SIFT_rsicd_features.pickle', 'rb'))

with open('/experiments/encoder/indexes/sift_dict_rsicd', "rb") as dict_file:
